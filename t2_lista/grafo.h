...
typedef struct t_aresta {
	int id;
	int peso; // ALTERAÇÃO PARA GRAFO PONDERADO
	vertice u, v;
} t_aresta;
...
int peso_aresta(aresta e); // GETTER PARA PESO
...
// calcula e atribui o peso para todas as arestas do grafo
void calcula_pesos_arestas(grafo G); // ADICIONADO
