...
#include "lista.h" // Mantido pela compatibilidade entre grafo.h de v1 e v2
#include <stdio.h>
#include <stdlib.h>
...
// getters para acessar informacoes internas do grafo de forma segura
...
//--------------------------------------------------------- ALTERAÇÃO PARA T2
// funcao para grafos direcionados
